...
export const useAuthStore = create((set, get) => ({
  ...
  signup: async (data) => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.message || "Failed to create account", { id: "signup-error" });
    } finally {
  ...
  login: async (data) => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.message || "Failed to login", { id: "login-error" });
    } finally {
  ...
  logout: async () => {
    try {
      ...
      toast.error(error?.response?.data?.message || "Failed to logout", { id: "logout-error" });
    }
  },
